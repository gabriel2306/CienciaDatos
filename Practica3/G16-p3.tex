...
\bigskip
Por último, calculamos el \textbf{Error estándar.}
\begin{Schunk}
\begin{Sinput}
...
\end{Soutput}
\begin{Sinput}
> (recta<-calcularRecta(planetas$R,planetas$D,mean(planetas$R),mean(planetas$D)))
\end{Sinput}
\begin{Soutput}
$a
[1] 4.362396
...
\end{Soutput}
\begin{Sinput}
> (errorE(planetas$R,planetas$D,recta))
\end{Sinput}
\begin{Soutput}
[1] 0.5982136
\end{Soutput}
...
Dicho error tiene valores entre [0,1], indicando un 0 un buen ajuste de la recta.
