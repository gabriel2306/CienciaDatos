...
\bigskip
Por último, mostramos por pantalla el mapa con una leyenda que muestra la escala de salarios. A su vez,
elegimos los colores de la escala de blanco (salario bajo) a negro (salario alto) porque se visualiza 
mejor que con cualquier otra escala de colores. Por último, añadimos el título y eliminamos el fondo.
\begin{Schunk}
\begin{Sinput}
